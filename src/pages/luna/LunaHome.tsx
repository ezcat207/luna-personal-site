...
const LunaHome = () => {
  ...
  return (
    <div className="space-y-20">
      ...
      >
        <div className="bg-gradient-to-r from-pink-50 via-rose-50 to-pink-50 border-2 border-pink-100 rounded-3xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
          <div className="flex items-center gap-4 text-left">
            <div className="w-12 h-12 bg-pink-500 text-white rounded-2xl flex items-center justify-center shadow-md shrink-0">
              <BookOpen className="w-6 h-6" />
            </div>
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">Illustrated Comics Library 📖</h2>
              <p className="text-slate-500 text-sm mt-1">Read about Wayne and Luna's real-life and fantasy travel adventures!</p>
            </div>
          </div>
          <Link
            to="/luna/comics"
