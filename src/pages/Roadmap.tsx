  ...
  zh: {
    ...
    resources: [
      ...
      },
      {
        ...
        category: "工程与项目流",
        title: "专业级开发工作流",
        tools: [{ name: "Claude Code", url: "https://github.com/ezcat207/learn-claude-code-kid/" }, { name: "Linear", url: "https://linear.app/" }],
...
export default function Roadmap() {
  ...
  return (
    <div className="min-h-screen pt-12 pb-24 relative z-10 w-full selection:bg-highlighter-pink text-ink font-sans">
      
      {/* Header */}
      <header className="relative group mb-12 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="tape top-[-10px] left-[50%] z-10"></div>
        <div className="paper-sheet torn-edge rotate-[0.5deg]">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="p-1.5 md:p-2 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 rounded-md transition-colors flex items-center shadow-sm"
            ...
            <div className="flex bg-gray-100 p-1 rounded-lg overflow-x-auto w-full md:w-auto">
              <button
                ...
                className={`whitespace-nowrap px-4 py-2 text-sm font-medium rounded-md transition-all flex items-center ${
                  activeTab === 'decision' 
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="paper-sheet rotate-[-0.5deg] mb-12 flex flex-col md:flex-row gap-4">
          <div className="tape top-[-5px] right-[10%] rotate-6 z-10"></div>
          <p className="text-indigo-900 leading-relaxed text-sm md:text-base">
            {t.intro}
          </p>
        </div>
      ...
      {/* Footer */}
      <footer className="paper-sheet rotate-[-1deg] max-w-xl mx-auto mt-12 py-8 text-center text-sm text-pencil">
        <p>{t.footer}</p>
      </footer>
    </div>
  );
