...
export const wayneInsights: WayneInsight[] = [
  ...
  },
  {
    ...
    content: [
      ...
      '两人合作时，对方的棋子天然就在棋盘另一侧——双方棋子在中间区域交汇时，形成了一个**双向高速通道**：我的棋子借你的跳，你的棋子借我的跳，同时推进，建桥和连跳几乎同步发生。',
      ...
      '它给了一个**效率参照系**。实战里，Wayne 大约 20～22 步进营，Luna 大约 23～26 步。当 Luna 走到第 28 步还没进营，Wayne 会说：「合作状态下 15 步就行，你现在走的哪些是真的没必要的？」',
  ...
  },
  {
    ...
    content: [
      ...
      '不是为了教她编程。而是因为她的兴趣已经**强到可以支撑一个真实产品**。',
      ...
      '这是关键时刻。',
      '之前，她做的是**自己喜欢的东西**（哈利波特）。',
      '现在，她开始考虑**别人的需求**（Frozen）。',
      '我说："可以，但你要帮我想 Frozen 的题目。"',
      'Luna："好！我今天就写！"',
      '这是**从"我想要"到"用户需要"的转变**——产品思维的核心。',
  ...
  },
  {
    ...
    content: [
      ...
      '我："对！这些都是**关键词**。我们要把这些词放进网站标题，这样 Google 才知道我们是做什么的。"',
      '**第二课：用户视角（CTR 优化）**',
      '我给她看两个标题：',
      '- A: "FandomTrivia - Quiz"',
