...
export const wayneCourses: WayneCourse[] = [
  ...
  },
  {
    ...
    subtitle: 'From blank prompt to shareable creation — DALL-E, Midjourney, Runway, Kling',
    description:
      'Learn to generate stunning images and short videos with AI. No design or art experience needed — just ideas. Wayne teaches the prompting craft. Luna demonstrates what an 8-year-old can make.',
    tier: 'paid',
    price: 99,
    status: 'coming-soon',
    duration: '5 weeks',
    level: 'Beginner',
    tags: ['DALL-E', 'Midjourney', 'Runway', 'Kling AI', 'AI Art'],
    learningOutcomes: [
      'Generate professional-quality images from text descriptions',
      'Control style, composition, mood, and detail through prompting',
      'Keep characters consistent across multiple images',
      'Create short AI videos from text and from your own images',
      'Build a personal style library for consistent AI visuals',
      'Complete a family creative project: an illustrated story or mini AI film',
    ],
    tools: ['DALL-E 3', 'Midjourney', 'Ideogram', 'Runway Gen-3', 'Kling AI', 'CapCut AI'],
    modules: [
      {
        number: 0,
        title: 'The AI Visual Revolution',
        description: 'What changed, why it matters now, and what you will be able to make by Week 5.',
        lessons: [
          { title: 'Before and After: What AI Did to Creative Work', type: 'article', duration: '8 min' },
          { title: "Luna's Gallery: What She Made in One Month", type: 'video', duration: '5 min' },
          { title: 'Tool Overview: Which App for Which Job', type: 'article', duration: '10 min' },
        ],
      },
      {
        number: 1,
        title: 'Image Prompting 101',
        description: 'Anatomy of a prompt. Subject, context, style, mood, format. Your first 20 images.',
        lessons: [
          { title: 'DALL-E 3: Account Setup + First Image', type: 'practice', duration: '15 min' },
          { title: 'Anatomy of a Prompt: The 5 Elements', type: 'article', duration: '12 min' },
          { title: 'Practice: 20 Images, 20 Lessons', type: 'practice', duration: '30 min' },
          { title: 'Why Vague Prompts Fail (and How to Fix Them)', type: 'article', duration: '10 min' },
        ],
      },
      {
        number: 2,
        title: 'Style & Control',
        description: 'Reference images, aspect ratios, negative prompts, Midjourney vs Ideogram.',
        lessons: [
          { title: 'Midjourney: Setup + Interface Tour', type: 'article', duration: '15 min' },
          { title: 'Style References: Make AI Match Your Vision', type: 'practice', duration: '20 min' },
          { title: 'Aspect Ratios + Composition Control', type: 'article', duration: '10 min' },
          { title: 'Ideogram: When Text in Images Actually Works', type: 'practice', duration: '15 min' },
          { title: 'Build Your Personal Style Library', type: 'practice', duration: '25 min' },
        ],
      },
      {
        number: 3,
        title: 'Characters & Consistency',
        description: 'The hardest problem in AI images: making the same character appear in multiple scenes.',
        lessons: [
          { title: 'Why Consistency Is Hard (and Why It Matters)', type: 'article', duration: '8 min' },
          { title: 'Character Sheet: Define Your Character in Prompts', type: 'practice', duration: '20 min' },
          { title: 'Image Reference Techniques for Consistent Faces', type: 'practice', duration: '25 min' },
          { title: "Luna's Character: How We Made 'Mars Bunny' Consistent", type: 'video', duration: '8 min' },
        ],
      },
      {
        number: 4,
        title: 'AI Video Basics',
        description: 'Text-to-video and image-to-video with Runway Gen-3 and Kling AI.',
        lessons: [
          { title: 'How AI Video Works: What It Can and Cannot Do', type: 'article', duration: '10 min' },
          { title: 'Runway Gen-3: Your First Text-to-Video Clip', type: 'practice', duration: '20 min' },
          { title: 'Kling AI: Image-to-Video (Animate Your Illustrations)', type: 'practice', duration: '20 min' },
          { title: 'Prompting for Motion: Camera Moves + Action Descriptions', type: 'article', duration: '12 min' },
          { title: 'CapCut AI: Assemble Clips into a Short Film', type: 'practice', duration: '25 min' },
        ],
      },
      {
        number: 5,
        title: 'Family Project: Your AI Film or Story',
        description: 'Combine everything: illustrated story or 60-second AI film. Wayne + Luna show theirs first.',
        lessons: [
          { title: "Wayne + Luna's Project Walkthrough (Full Process)", type: 'video', duration: '15 min' },
          { title: 'Project Brief: Choose Your Format + Plan Your Story', type: 'practice', duration: '20 min' },
          { title: 'Production Week: Build It', type: 'practice', duration: '90 min' },
          { title: 'Share It: Where to Post Your Family Creation', type: 'article', duration: '8 min' },
        ],
      },
    ],
  },
